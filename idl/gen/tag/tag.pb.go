...
type QueryTagByTagIDReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *QueryTagByTagIDReq) Reset() {
	*x = QueryTagByTagIDReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_tag_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *QueryTagByTagIDReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryTagByTagIDReq) ProtoMessage() {}

func (x *QueryTagByTagIDReq) ProtoReflect() protoreflect.Message {
	mi := &file_idl_tag_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryTagByTagIDReq.ProtoReflect.Descriptor instead.
func (*QueryTagByTagIDReq) Descriptor() ([]byte, []int) {
	return file_idl_tag_proto_rawDescGZIP(), []int{12}
}

func (x *QueryTagByTagIDReq) GetTagId() []string {
	if x != nil {
		return x.TagId
	}
	return nil
...
type QueryTagByTagIDResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BaseResp   *BaseResp       `protobuf:"bytes,1,opt,name=base_resp,json=baseResp,proto3" json:"base_resp,omitempty"`
	TagId_2Tag map[string]*Tag `protobuf:"bytes,2,rep,name=tag_id_2_tag,json=tagId2Tag,proto3" json:"tag_id_2_tag,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *QueryTagByTagIDResp) Reset() {
	*x = QueryTagByTagIDResp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_tag_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *QueryTagByTagIDResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryTagByTagIDResp) ProtoMessage() {}

func (x *QueryTagByTagIDResp) ProtoReflect() protoreflect.Message {
	mi := &file_idl_tag_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryTagByTagIDResp.ProtoReflect.Descriptor instead.
func (*QueryTagByTagIDResp) Descriptor() ([]byte, []int) {
	return file_idl_tag_proto_rawDescGZIP(), []int{13}
}

func (x *QueryTagByTagIDResp) GetBaseResp() *BaseResp {
	if x != nil {
		return x.BaseResp
	}
	return nil
...
func (x *QueryTagByTagIDResp) GetTagId_2Tag() map[string]*Tag {
	if x != nil {
		return x.TagId_2Tag
	}
	return nil
...
var file_idl_tag_proto_rawDesc = []byte{
	...
	,
...
var file_idl_tag_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_idl_tag_proto_goTypes = []interface{}{
	...
	(*QueryTagByTagIDReq)(nil),     // 12: tag.QueryTagByTagIDReq
	(*QueryTagByTagIDResp)(nil),    // 13: tag.QueryTagByTagIDResp
	nil,                            // 14: tag.QueryTagByTagIDResp.TagId2TagEntry
}
var file_idl_tag_proto_depIdxs = []int32{
	...
	0,  // 9: tag.QueryTagByTagIDResp.base_resp:type_name -> tag.BaseResp
	14, // 10: tag.QueryTagByTagIDResp.tag_id_2_tag:type_name -> tag.QueryTagByTagIDResp.TagId2TagEntry
	1,  // 11: tag.QueryTagByTagIDResp.TagId2TagEntry.value:type_name -> tag.Tag
	2,  // 12: tag.TagService.CreateTag:input_type -> tag.CreateTagReq
	4,  // 13: tag.TagService.QueryMovieTag:input_type -> tag.QueryMovieTagReq
	6,  // 14: tag.TagService.QueryUserTagCloud:input_type -> tag.QueryUserTagCloudReq
	8,  // 15: tag.TagService.QueryTagRecords:input_type -> tag.QueryTagRecordsReq
	10, // 16: tag.TagService.QueryMovieTopNTags:input_type -> tag.QueryMovieTopNTagsReq
	12, // 17: tag.TagService.QueryTagByTagID:input_type -> tag.QueryTagByTagIDReq
	3,  // 18: tag.TagService.CreateTag:output_type -> tag.CreateTagResp
	5,  // 19: tag.TagService.QueryMovieTag:output_type -> tag.QueryMovieTagResp
	7,  // 20: tag.TagService.QueryUserTagCloud:output_type -> tag.QueryUserTagCloudResp
	9,  // 21: tag.TagService.QueryTagRecords:output_type -> tag.QueryTagRecordsResp
	11, // 22: tag.TagService.QueryMovieTopNTags:output_type -> tag.QueryMovieTopNTagsResp
	13, // 23: tag.TagService.QueryTagByTagID:output_type -> tag.QueryTagByTagIDResp
...
func file_idl_tag_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_idl_tag_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryTagByTagIDReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_idl_tag_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryTagByTagIDResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
