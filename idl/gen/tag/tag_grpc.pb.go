...
type TagServiceClient interface {
	...
	QueryTagByTagID(ctx context.Context, in *QueryTagByTagIDReq, opts ...grpc.CallOption) (*QueryTagByTagIDResp, error)
}
...
func (c *tagServiceClient) QueryTagByTagID(ctx context.Context, in *QueryTagByTagIDReq, opts ...grpc.CallOption) (*QueryTagByTagIDResp, error) {
	out := new(QueryTagByTagIDResp)
	err := c.cc.Invoke(ctx, "/tag.TagService/QueryTagByTagID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TagServiceServer interface {
	...
	QueryTagByTagID(context.Context, *QueryTagByTagIDReq) (*QueryTagByTagIDResp, error)
...
func (UnimplementedTagServiceServer) QueryTagByTagID(context.Context, *QueryTagByTagIDReq) (*QueryTagByTagIDResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryTagByTagID not implemented")
}
...
func _TagService_QueryTagByTagID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryTagByTagIDReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TagServiceServer).QueryTagByTagID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tag.TagService/QueryTagByTagID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).QueryTagByTagID(ctx, req.(*QueryTagByTagIDReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TagService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "QueryTagByTagID",
			Handler:    _TagService_QueryTagByTagID_Handler,
		},
	},
