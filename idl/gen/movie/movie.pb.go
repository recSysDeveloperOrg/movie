...
type ModifyMovieRatingReq struct {
	...
	NUpdate   int64  `protobuf:"varint,2,opt,name=n_update,json=nUpdate,proto3" json:"n_update,omitempty"`
...
func (x *ModifyMovieRatingReq) GetNUpdate() int64 {
	if x != nil {
		return x.NUpdate
	}
	return 0
...
var file_idl_movie_proto_rawDesc = []byte{
	...
	0x08, 0x6e, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
